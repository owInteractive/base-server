...
read -p "Nome do projeto no bitbucket " project
echo "$project"

rm -rf /var/www/html/$project
git clone git@bitbucket.org:owinteractive/$project.git /var/www/html/$project


# git clone git@bitbucket.org:owinteractive/api-nest.base.com.git